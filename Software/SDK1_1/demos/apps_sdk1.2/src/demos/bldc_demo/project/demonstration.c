...
void Demonstration(MCSTRUC_BLDC_SNLS_INT_T * sM_Drive)
{
        ...
        case 3:       // Both Switches
            ...
            if (uw16SwBothCnt == PUSH_TIME_LONG)
            {
                ...
                else
                {
                    ...
                    GPIO_HAL_SetPinOutput(GPIOD_BASE, 6);//DEMO_LED_OFF;
                }
            }
            uw16Sw1Cnt = 0;
            uw16Sw2Cnt = 0;
    ...
    if (uw16DemonstrationStatus == 1)
    {
        ...
        if (uw32DemoTime & 128) GPIO_HAL_SetPinOutput(GPIOD_BASE, 6);   //DEMO_LED_OFF;
        else                    GPIO_HAL_ClearPinOutput(GPIOD_BASE, 6); //DEMO_LED_ON;
