...
void de_init_pins(void)
{
    ...
    /* PORTC_PCR8 */
    PORT_HAL_SetMuxMode(PORTC,8u,kPortPinDisabled);
    /* PORTC_PCR9 */
    PORT_HAL_SetMuxMode(PORTC,9u,kPortPinDisabled);
    ...
    /* PORTC_PCR10 */
    PORT_HAL_SetMuxMode(PORTC,10u,kPortPinDisabled);
    /* PORTC_PCR11 */
    PORT_HAL_SetMuxMode(PORTC,11u,kPortPinDisabled);
    ...
    /* PORTE_PCR26 */
    PORT_HAL_SetMuxMode(PORTE,26u,kPortPinDisabled);
    ...
    /* PORTD_PCR1 */
    PORT_HAL_SetMuxMode(PORTD,1u,kPortPinDisabled);
    /* PORTD_PCR2 */
