...
void configure_i2c_pins(uint32_t instance)
{
  switch(instance) {    
    case 0:                             /* I2C0 */
      /* PORTE_PCR24 */
      PORT_HAL_SetMuxMode(PORTE,24u,kPortMuxAlt5); /*I2C0_SCL */
      PORT_HAL_SetOpenDrainCmd(PORTE,24u,true);
      /* PORTE_PCR25 */
      PORT_HAL_SetMuxMode(PORTE,25u,kPortMuxAlt5); /*I2C0_SDA*/
...
void configure_spi_pins(uint32_t instance)
{
  switch(instance) {    
    case 0:                             /* SPI0 */
      /* PORTD_PCR0 */
      PORT_HAL_SetMuxMode(PORTD,0u,kPortMuxAlt2); /*SPI0_PCS0 */
      /* PORTD_PCR3 */
      PORT_HAL_SetMuxMode(PORTD,3u,kPortMuxAlt2); /*SPI0_SIN */
      /* PORTD_PCR1 */
      PORT_HAL_SetMuxMode(PORTD,1u,kPortMuxAlt2); /*SPI0_SCK */
      /* PORTD_PCR2 */
      PORT_HAL_SetMuxMode(PORTD,2u,kPortMuxAlt2); /*SPI0_SOUT*/
      break;
    /* SPI1 */
